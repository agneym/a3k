var events = {
    "aei": [
        {
            ...
            "date": "17-March-2017",
            "rules": "•	A team can have a maximum of three members.</br>•	Individual participation is allowed.</br>•	The initial screening will consist of a quiz based on Arduino programming consisting of 30 questions.</br>•	The top five teams will be selected for the final round.</br>•	These five teams will be given a problem statement with a model of the project. The teams will have to code the Arduino program required as a solution and test it on the model, the team to finish first will be judged as winners.</br>•	No team is allowed access to the Internet.</br>•	The problem statement will be given during the event.</br>•	Teams are requested to get their own laptops.</br>•	The competition aims at beginners in Arduino programming.</br>•	The model of the project will constitute all the components required for the problem statement, the participants skill in Arduino programming is tested here.</br>•	The teams should ensure that they do not take part in any malpractices, if any of the members are found guilty of malpractices the team shall be disqualified immediately.</br>•	The decisions of the judges will be final.</br>•	Tie-breakers may have to undergo another round, depending on the judges decision.</br>",
            "nop": "1-3",
    ...
    "ce" : [
        {
            "name": "DEXTER",
            "description": "The competition will be conducted in 4 rounds.<br/>Round 1 will be a Written Elimination Round.<br/>Remaining rounds will be a test to your civil engineering skill and practical expertise, further details of which will be revealed at the competition.<br/>All the necessary equipments will be provided, however each participant is required to carry a ballpoint PEN.<br/>The competition will begin at sharp 9.30 am. Don’t test your chances be there on time because it is Rs.16000 that is waiting for you.All the best DEXTER, we can’t wait to see you!!!",
            "rules": "",
            "date": "17-March-2017",
            "nop": "1",
        ...
        {
            "name": "CONCRETE KING",
            "rules": "<br/>RULES <br/> Concrete mix design: IS method <br/> Cube size: 150 mm x 150 mm x 150 mm <br/> Grade of cement: 53 grade <br/> Maximum size of aggregates: 20 mm <br/> Submit a mix design report along with the cubes. With the following details <br/>1.Materials used <br/>2.Mix proportion <br/>3.Water-cement ratio <br/>4.Details of admixture <br/>5.Details of cement and other materials used <br/> Concrete grade: M50 <br/> Identification mark: Place a two-rupee coin on the corner of the cube and mark the date of <br/>casting on the side with the coin. <br/> Test will be to check the seven day strength. <br/> Testing date: 18-03-2017 <br/> Maximum number of team members: 3 <br/> Maximum number of cubes that can be submitted by a team: 3 <br/> Judging criteria: <br/>1.Mix design report <br/>2.Strength <br/>3.The percent error to the theoretical value should be low <br/>4.The strength to weight ratio should be high (this criterion is applicable only if there is tie <br/>between teams) <br/> The use of fiber, paper, thermocol, reinforcement and plastic materials may result in <br/>disqualification <br/> Decision of committee will be final",
            "date": "18-March-2017",
            "description": "",
            "nop": "1-3",
    ...
    "it": [
        {
            ...
            "rules": "1.	Be that Team. (Min 3 – Max 5)<br/>2.	Each team must bring a laptop.<br/>3.	Software required should be preinstalled in your laptops.<br/>4.	Judges decision will be final<br/>",
            "nop": "3-5",
    ...
    "cs": [
        {
            ...
            "date": "18-March-2017",
            "description": "Shout out to all the techies out there!! Come test your skills in the exciting challenge. Comprising of three tech rounds, this game will crown the ultimate coders🙇🙇‍♀. Play as a two player team and beat the other groups in a tech quiz💡 round to proceed to the debugging round. Fix those bugs and get your clue for the next level the coding round⚔. First team to complete, walks away with the prize🎁. Come, code your way to glory!!",
        ...
        },
        {
            ...
            "date": "17-March-2017",
            "description": "This event tests the threefold compatibility of every participant in the areas of logical, mathematical and basic programming skills. This game introduces the player to an intriguing program the output of which they have to decrypt.🔓 The code has to be further optimised to minimise the runtime.⏳ <br/><br/>Talk about brain-wrecking!! Come and try deobsufication !!👓",
        ...
        },
        {
            "name": "REVIMAGE",
            "date": "18-March-2017",
            "description": "Think you know the art of Googling?!🔎  Come test your expertise in the RevImage challenge.. Get the given image in the top ten search results soon and walk away with the ultimate prize🎁",
        ...
        },
        {
            ...
            "description": "50 WPM!!  Too tame?  Well Crack those knuckles and flex those fingers and get ready to heat things up with the fast fingers👐 challenge!  See how much you can type in under a minute⏱.  Let's get those keys on fire!!!🔥",
    ...
    "eee": [
        ...
        {
            "name": "ROBOWAR",
            "description": "<br/>⚔ ROBOWAR ⚔ <br/>By the department of Electrical and Electronics Engineering. <br/><br/>Gear up your bots and get ready for the final showdown! 🏰<br/>🗡Not swords, but controllers🗡 <br/>🔌Not canons, but sensors🔌<br/>Wire them up right and let the robos talk the rest! ",
            "date": "17-March-2017",
    ...
    "mech": [
        {
            "name": "MECHMERIZE",
            "description": "⚙ PLAN BUILD WIN ⚙ <br/> <br/> 🔩The quest for the mechanical throne👑 begins. Get ready to don the thinking caps and gear towards shaping your engineering skills👷🏻. Bring out your team of 3 and show who is the real boss!!!😎 <br/> <br/>🔧Kindle the mechanic👨🏻‍🔧 in you and show the world your engineering expertise.🔨",
            "date": "17-March-2017",
            "rules": "1.  In this event 3 to 4 groups will be competing at the same time.<br/>2.	Each group should have only a maximum number of 3 person.<br/>3.	Each group will be given a fixed amount of money of 20000. There will be a shop where all kinds of necessary materials and tools are available.<br/>4.	All tools have a rent to be paid for the tools to be used for a certain period of time. If the tool is used beyond the allotted period, rent for the next period is reduced from the group’s given amount.<br/>5.	All materials also have a price to be paid. Materials purchased in bulk will be sold at a discount rate.<br/>6.	The groups will be provided with a design. It could be a small object, a simple mechanism or a structure. Each group will be given a time frame of 20 to 30 minutes. Each minute has a money value of 200.<br/>7.	Each group should complete the task using the given materials and tools in the shop within the given time frame.<br/>8.	If a group completes the job before the given time, the remaining time will be added to the group’s remaining money.<br/>9.	After the job of every group is complete, the group will be given a task to be completed using the made object. There is no additional points or competition for completing the task. However, if the group fails to complete the task, the group’s object is considered a failure and the group loses.<br/>10.	If the task is completed successfully, then the remaining money of all the groups are compared. The group with the largest amount of remaining money is qualified to the finals.<br/>11.	All the finalists again compete in the finals with the same set of rules. The team that wins here, is the winner!!!<br/>",
            "nop": "3",
    ...
    "non-tech": [
        {
            ...
            "date": "18-March-2017",
            "description": "Let's play with the knowledge, time and a lot of money.... <br/> <br/>Be a Genghis Khan⚔🛡 of the computer era. Follow the clues on www.facebook.com/ctg2k17 <br/> <br/>Go, see and conquer the nations one by one. You can use anything to win...📱💻 Internet, Mobilephone... Nuclear weapons are exempted...😇 <br/> <br/>No one has two best friends so the number of members in a team is limited to to... Yeah! No one's going to complain even you do it alone. <br/> <br/>See you on the battle field... <br/>",
            "rules": "",
            "nop": "1",
        ...
        },
        {
            "name": "Amazing Race",
            "date": "17-March-2017",
            "description": "Put your wits and guts to test as you fire up the adventurer in you. ⛷🏹🚴‍♀🔥 Get out there and hunt and fish and mess around with your friends, ramble out yonder and explore as you get your mind-boggled by the most incredible and exhilarating event of A3K 2017🎈💥Grab your chance.Limited seats only.",
        ...
        },
        {
            ...
            "description": "Do you have a Sherlock in you?<br/>Do you think you have what it takes to solve a crime?<br/>🔰🔰🔰🔰🔰🔰🔰🔰🔰🔰🔰<br/>Rajagiri School of Engineering and Technology proudly presents <br/></strong>221B BAKER STREET</strong> <br/><br/>🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹<br/><br/>🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹<br/> The game is on!<br/> THINK BEYOND!<br/>  MAKE DEDUCTIONS!<br/>  Come and play on <br/>1⃣7⃣▪0⃣3⃣▪2⃣0⃣1⃣7⃣<br/>🔸🔸🔸🔸🔸🔸🔸🔸🔸🔸🔸<br/>The stage is set<br/>The curtain rises<br/>Are you ready to begin?",
            "date": "17-March-2017",
